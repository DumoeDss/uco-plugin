...
namespace com.AtelierAI.Unity.Copilot.Editor.Tests.JsonConverter
{
    using com.AtelierAI.Unity.Copilot.Editor.Tests;
    ...
    public class GameObjectRefConverterTests : BaseTest
    {
        ...
        public void GameObjectRef_InstanceID_BeyondJsSafeInteger_SurvivesJsParse()
        {
            ...
            var reflector = UnityCopilotPluginEditor.Instance.Reflector
