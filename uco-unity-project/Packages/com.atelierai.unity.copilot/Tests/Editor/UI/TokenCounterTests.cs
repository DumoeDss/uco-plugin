...
namespace com.AtelierAI.Unity.Copilot.Editor.Tests
{
    public class TokenCounterTests : BaseTest
    {
        ...
        {
            // Act
            var formatted = UICopilotUtils.FormatTokenCount(345);
        ...
        {
            // Arrange & Act
            var formatted1K = UICopilotUtils.FormatTokenCount(1000);
            var formatted15K = UICopilotUtils.FormatTokenCount(1500);
            var formatted2K = UICopilotUtils.FormatTokenCount(2345);
        ...
        {
            // Arrange
            var tools = UnityCopilotPluginEditor.Instance.Tools!.GetAllTools();
