...
using com.AtelierAI.Unity.Copilot.TestFiles;
...
namespace com.AtelierAI.Unity.Copilot.Editor.Tests
{
    ...
    public class BlacklistTypeTests : BaseTest
    {
        ...
        /// <summary>
        /// Creates a new Reflector configured similarly to UnityCopilotPluginEditor.CreateDefaultReflector()
        /// but with custom blacklisted types for testing.
        /// </summary>
        private Reflector CreateTestReflector()
        {
            return UnityCopilotPluginEditor.Instance.CreateDefaultReflector();
        }
        ...
        public IEnumerator Serialize_Component_BlacklistByTypeName_ShouldNotContainBlacklistedField()
        {
            ...
            var type = com.IvanMurzak.ReflectorNet.Utils.TypeUtils.GetType(fullTypeName);
