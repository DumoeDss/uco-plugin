...
namespace com.AtelierAI.Unity.Copilot.Editor.DependencyResolver
{
    ...
    static class NuGetPackageInstaller
    {
        ...
        ///       (e.g., a leftover "Microsoft.Extensions.Logging.Abstractions" at 10.0.3 when the
        ...
        /// or "Microsoft.Extensions.Logging.Abstractions.8.0.3".
        ...
        internal static string? ExtractPackageIdFromDirName(string dirName)
        {
            ...
            for (var i = 1; i < parts.Length; i++)
            {
                ...
                // those (e.g. Microsoft.Extensions.Logging.8.0.1-preview), so
