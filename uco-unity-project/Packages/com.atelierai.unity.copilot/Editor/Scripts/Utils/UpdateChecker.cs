...
namespace com.AtelierAI.Unity.Copilot.Editor.Utils
{
    ...
    public static class UpdateChecker
    {
        ...
        /// </summary>
        /// <remarks>
        /// Stored in <see cref="UnityCopilotUpdateProjectSettings"/> — a <see cref="ScriptableSingleton{T}"/>
        /// persisted under <c>ProjectSettings/</c>. The asset is intended to be committed to VCS.
        /// </remarks>
        public static bool IsDisabledForProject
        {
            get => UnityCopilotUpdateProjectSettings.instance.DisableUpdateNotificationsForTeam;
            set => UnityCopilotUpdateProjectSettings.instance.DisableUpdateNotificationsForTeam = value;
        }
        ...
        public static async Task CheckForUpdatesAsync(bool forceCheck = false)
        {
            ...
            try
            {
                ...
                var currentVersion = UnityCopilotPlugin.Version;
