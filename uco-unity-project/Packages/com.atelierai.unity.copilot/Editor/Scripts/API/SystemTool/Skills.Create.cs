...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    public partial class Tool_Skills
    {
        ...
        [Description("Create a new skill using C# code. " +
            ...
            "Data models for tools MUST be declared as TOP-LEVEL types in the `AIGD` namespace - " +
            ...
            "(without `ResponseCallValueTool<T>`) and the plugin will wrap it automatically. " +
