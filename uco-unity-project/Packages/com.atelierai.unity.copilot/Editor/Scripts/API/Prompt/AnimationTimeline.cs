...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    ...
    {
        [UcoPrompt(Name = "setup-animator-controller", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-simple-tweening", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-timeline-sequence", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "add-animation-events", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-procedural-animation", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-sprite-animation", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "add-ik-system", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-animation-blending", Role = Role.User, Enabled = false)]
