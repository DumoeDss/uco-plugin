...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    ...
    {
        [UcoPrompt(Name = "add-debug-visualization", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-performance-profiling", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-test-scene", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "add-logging-system", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-unit-tests", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-debug-ui", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "add-assertion-checks", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-automated-tests", Role = Role.User, Enabled = false)]
