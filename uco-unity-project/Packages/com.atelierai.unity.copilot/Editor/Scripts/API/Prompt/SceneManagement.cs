...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    ...
    {
        [UcoPrompt(Name = "setup-basic-scene", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "organize-scene-hierarchy", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "add-lighting-setup", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-prefab-from-selection", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-scene-camera", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-environment-template", Role = Role.User, Enabled = false)]
