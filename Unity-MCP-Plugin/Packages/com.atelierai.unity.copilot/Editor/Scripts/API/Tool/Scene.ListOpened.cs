...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    public partial class Tool_Scene
    {
        ...
        [UcoSkillDescription("List every scene currently opened in the Unity Editor as a shallow snapshot " +
            "(name, path, build flags). Use '" + SceneGetDataToolId + "' for the deep view of a specific scene.")]
        [UcoSkillBody("Returns the list of currently opened scenes in Unity Editor. " +
