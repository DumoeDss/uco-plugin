...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    ...
    {
        [UcoPrompt(Name = "add-standard-components", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-player-controller", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-ui-canvas", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "add-physics-interactions", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-interactive-object", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-audio-source", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-particle-effects", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-animator-component", Role = Role.User, Enabled = false)]
