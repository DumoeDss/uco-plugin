...
namespace com.AtelierAI.Unity.Copilot.Editor.API
{
    ...
    {
        [UcoPrompt(Name = "organize-project-structure", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "import-setup-sprites", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-audio-manager", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "configure-build-settings", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "create-material-library", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-asset-bundles", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "optimize-texture-settings", Role = Role.User, Enabled = false)]
        ...
        [UcoPrompt(Name = "setup-addressables", Role = Role.User, Enabled = false)]
