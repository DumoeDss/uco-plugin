...
namespace com.AtelierAI.Unity.Copilot
{
    ...
    public partial class UnityCopilotPluginRuntime
    {
        static readonly Subject<UnityConnectionConfig> _onConfigChanged = new Subject<UnityConnectionConfig>();
        static readonly ILogger _logger = UnityLoggerFactory.LoggerFactory.CreateLogger<UnityCopilotPluginRuntime>();
        static readonly object _instanceMutex = new();

        static UnityCopilotPluginRuntime _instance = null!;
        ...
        public static UnityCopilotPluginRuntime Instance
        {
        ...
        static void InitSingletonIfNeeded()
        {
            ...
            {
                if (_instance == null)
                    _instance = new UnityCopilotPluginRuntime();
            }
        }
