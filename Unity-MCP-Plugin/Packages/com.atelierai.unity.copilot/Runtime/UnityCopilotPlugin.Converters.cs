...
using com.AtelierAI.Unity.Copilot.JsonConverters;
using com.AtelierAI.Unity.Copilot.Reflection.Converter;
...
namespace com.AtelierAI.Unity.Copilot
{
    public partial class UnityCopilotPlugin
    {
        public Reflector CreateDefaultReflector()
        {
            ...
            reflector.Converters.Add(new UnityEngine_EntityId_ReflectionConverter());
#endif
...
#if UNITY_6000_5_OR_NEWER
            reflector.JsonSerializer.AddConverter(new EntityIdConverter());
#endif
