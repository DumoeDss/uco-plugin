...
namespace com.AtelierAI.Unity.Copilot.Editor.Tests
{
    ...
    public class UpdateCheckerTests
    {
        ...
        {
            var json = @"{""name"":""com.atelierai.unity.copilot"",""dist-tags"":{""latest"":""0.67.0""},""versions"":{""0.67.0"":{}}}";
        ...
        {
            // Realistic abridged shape returned by https://package.openupm.com/com.atelierai.unity.copilot
            var json = @"{
        ...
        {
            var json = @"{""name"":""com.atelierai.unity.copilot"",""versions"":{""1.0.0"":{}}}";
        ...
        public void ReleasesUrl_PointsAtOpenUpm()
        {
            ...
            Assert.AreEqual(
                "https://openupm.com/packages/com.atelierai.unity.copilot/",
