...
using com.AtelierAI.Unity.Copilot.Editor.Extensions;
using AIGD;
    ...
    public IEnumerator ModifyJson_SolarSystem_Sun_NameComponent()
    {
      ...
      var json = $@"
            {{
              ...
              ""componentRef"": {{
                  ""typeName"": ""com.AtelierAI.Unity.Copilot.SolarSystem""
              }},
              ""componentDiff"": {{
                  ""typeName"": ""com.AtelierAI.Unity.Copilot.SolarSystem"",
                  ""fields"": [
            ...
            {{
              ...
              ""componentDiff"": {{
                  ...
                  ""fields"": [
                        {{
                          ""name"": ""planets"",
                          ""typeName"": ""com.AtelierAI.Unity.Copilot.SolarSystem+PlanetData[]"",
                          ""value"": [
                            {{
                              ""typeName"": ""com.AtelierAI.Unity.Copilot.SolarSystem+PlanetData"",
                              ""fields"": [
