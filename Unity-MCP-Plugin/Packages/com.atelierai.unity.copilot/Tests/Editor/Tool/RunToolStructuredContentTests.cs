...
namespace com.AtelierAI.Unity.Copilot.Editor.Tests
{
    ...
    public class RunToolStructuredContentTests
    {
        ...
        public void SetUp()
        {
            ...
            _reflector.JsonSerializer.AddConverter(new com.AtelierAI.Unity.Copilot.JsonConverters.Vector3Converter());
            _reflector.JsonSerializer.AddConverter(new com.AtelierAI.Unity.Copilot.JsonConverters.ColorConverter());
            _reflector.JsonSerializer.AddConverter(new com.AtelierAI.Unity.Copilot.JsonConverters.QuaternionConverter());
