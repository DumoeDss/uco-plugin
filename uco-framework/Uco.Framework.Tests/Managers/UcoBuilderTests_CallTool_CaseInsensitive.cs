...
namespace com.AtelierAI.Uco.Framework.Tests.Managers
{
    ...
    /// <summary>
    /// Tests for case-insensitive parameter name matching in Uco tool calls.
    ...
    public class UcoBuilderTests_CallTool_CaseInsensitive
    {
        private readonly ITestOutputHelper _output;
        private readonly XunitTestOutputLoggerProvider _loggerProvider;
        private readonly Version _version = new Version();

        public UcoBuilderTests_CallTool_CaseInsensitive(ITestOutputHelper output)
        {
            _output = output;
            _loggerProvider = new XunitTestOutputLoggerProvider(output);
        }

        private IUcoPlugin BuildUcoPluginWithTool(Type classType, string methodName)
        {
        ...
        {
            // Arrange
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_OneArg_IntReturn), nameof(Method_OneArg_IntReturn.AddOne));
            ...
            var response = await ucoPlugin.UcoManager.ToolManager!.RunCallTool(request);
        ...
        {
            // Arrange
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_TwoArgs_StringReturn), nameof(Method_TwoArgs_StringReturn.Concat));
        ...
        public async Task CallTool_WithNoParameters_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_NoArgs_StringReturn), nameof(Method_NoArgs_StringReturn.GetHello));
        ...
        public async Task CallTool_WithUnderscoreParameterName_CaseInsensitive_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_UnderscoreParam), nameof(Method_UnderscoreParam.Format));
        ...
        public async Task CallTool_WithNumberInParameterName_CaseInsensitive_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_NumberInParam), nameof(Method_NumberInParam.AddValue1));
        ...
        {
            // Arrange
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_ThreeParams), nameof(Method_ThreeParams.Combine));
        ...
        public async Task CallTool_WithMixedParamStyles_CaseInsensitive_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_MixedParamStyles), nameof(Method_MixedParamStyles.Mix));
        ...
        public async Task CallTool_PascalCaseMethodParam_WithLowerCase_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_PascalCaseParam), nameof(Method_PascalCaseParam.Process));
        ...
        {
            // Arrange
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_OptionalParams), nameof(Method_OptionalParams.Calculate));
        ...
        public async Task CallTool_WithCaseConflictParams_ExactMatch_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_CaseConflictParams), nameof(Method_CaseConflictParams.Process));
        ...
        public async Task CallTool_TheSameArguments_WithExactNames_ShouldSucceed()
        {
            ...
            var ucoPlugin = BuildUcoPluginWithTool(typeof(Method_TheSameArguments), nameof(Method_TheSameArguments.TheSameArguments));
