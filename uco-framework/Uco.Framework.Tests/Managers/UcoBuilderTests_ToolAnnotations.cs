...
namespace com.AtelierAI.Uco.Framework.Tests.Managers
{
    ...
    public class UcoBuilderTests_ToolAnnotations
    {
        ...
        private async Task<ResponseListTool> GetTool(string toolName)
        {
            ...
            var response = await ucoPlugin.UcoManager.ToolManager!.RunListTool(request);
