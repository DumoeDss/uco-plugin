...
namespace com.AtelierAI.Uco.Framework.Tests.Managers
{
    ...
    public class UcoPluginSkillPathTests : IDisposable
    {
        ...
        public UcoPluginSkillPathTests(ITestOutputHelper output)
        {
            _tempDir = Path.Combine(Path.GetTempPath(), $"UcoPluginSkillPathTests_{Guid.NewGuid():N}");
        ...
        public void ConnectionConfig_ProjectRootPath_IsNotSerialized()
        {
            ...
            // would resurrect Unity-Uco #761's path-portability bug.
            var config = new ConnectionConfig
            {
