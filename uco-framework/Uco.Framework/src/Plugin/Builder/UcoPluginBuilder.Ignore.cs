...
namespace com.AtelierAI.Uco.Framework
{
    public partial class UcoBuilder
    {
        ...
        public virtual IUcoPluginBuilder IgnoreAssembly(Assembly assembly)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder IgnoreAssembly(string assemblyName)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder IgnoreAssemblies(IEnumerable<Assembly> assemblies)
        {
            ThrowIfBuilt();
        ...
        public virtual IUcoPluginBuilder IgnoreAssemblies(params string[] assemblyNames)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder IgnoreNamespace(string namespaceName)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder IgnoreNamespaces(params string[] namespaceNames)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder RemoveIgnoredAssembly(Assembly assembly)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder RemoveIgnoredAssembly(string assemblyName)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder RemoveIgnoredAssemblies(IEnumerable<Assembly> assemblies)
        {
            ThrowIfBuilt();
            foreach (var assembly in assemblies)
            {
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder RemoveIgnoredAssemblies(params string[] assemblyNames)
        {
            ThrowIfBuilt();
            foreach (var name in assemblyNames)
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder RemoveIgnoredNamespace(string namespaceName)
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder RemoveIgnoredNamespaces(params string[] namespaceNames)
        {
            ThrowIfBuilt();
            foreach (var ns in namespaceNames)
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder ClearIgnoredAssemblies()
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder ClearIgnoredNamespaces()
        {
            ThrowIfBuilt();
        ...
        /// <returns>The current builder instance for method chaining.</returns>
        /// <exception cref="InvalidOperationException">Thrown if the builder has already been built.</exception>
        public virtual IUcoPluginBuilder ClearAllIgnored()
        {
            ThrowIfBuilt();
            _ignoreConfig.IgnoredAssemblies.Clear();
            _ignoreConfig.IgnoredAssemblyNames.Clear();
