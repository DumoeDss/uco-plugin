...
{
    /// <summary>
    /// Generates AI skill markdown files for each registered Uco tool.
    /// Skill files follow the AI Skills template format and describe how to call each tool
    /// via the direct HTTP API or Uco protocol, including JSON schemas for input and output.
    /// <para>
    ...
    public class SkillFileGenerator : ISkillFileGenerator
    {
        ...
        protected virtual void BuildHowToCallHeading(StringBuilder sb)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("Execute this tool directly via the Uco Plugin HTTP API:");
            sb.AppendLine();
        }
        ...
        ///
        /// Execute this tool directly via the Uco Plugin HTTP API:
        ///
        ///                          ← content appended HERE
        /// ```bash
